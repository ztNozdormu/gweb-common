...
## gweb-common功能 
配置 Golang web项目 基础服务（mysql、redis、http.client、log）比较繁琐，如果想**快速接入** 基础服务可以使用本类库。
没有多余复杂的功能，方便拓展系统其他公共功能。初始代码基于https://github.com/e421083458/golang_common，后期根据自己需要构建自己的基础类库。
...
```
go get -v https://github.com/ztNozdormu/go-common
```
2. 将配置文件拷贝到你的项目中，配置文件请参考：https://github.com/ztNozdormu/go-common/master/conf/dev
...
2019/10/10 21:00:32 ------------------------------------------------------------------------
2019/10/10 21:00:33 [INFO]  config=./conf/dev/
2019/10/10 21:00:33 [INFO]  start loading resources.
2019/10/10 21:00:33 [INFO]  success loading resources.
2019/10/10 21:00:33 ------------------------------------------------------------------------
2019-10-10T21:00:33.110 [INFO] log.go:58 _undef||message=todo sth||traceid=a9fe916a5d9f2b71317026f8104dc7b0||cspanid=||spanid=f461ba1b380704bb
2019/10/10 21:00:34 ------------------------------------------------------------------------
2019/10/10 21:00:34 [INFO]  start destroy resources.
2019/10/10 21:00:34 [INFO]  success destroy resources.
